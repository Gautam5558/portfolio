...
export default function ProjectShowcase({
  ...
  return (
    <section className="overflow-hidden px-6 py-32 min-sm:px-14 min-md:px-20">
      <div className="relative mx-auto max-w-7xl">
          ...
          <AnimatePresence>
            ...
            >
              <Image
                ...
                width={100}
                height={100}
                className="h-auto w-1/2 rounded-lg border border-zinc-300 shadow-lg"
          ...
          {projectsData.map((project) => (
            ...
            >
              <div className="flex gap-2 group">
                ...
                <span
                  key={project.title}
                  className="underline-offset-1 text-3xl font-semibold text-red-400 group-hover:underline group-hover:text-red-500 duration-300 min-sm:text-4xl min-md:text-5xl min-lg:hidden"
                >
                  {project.title}
                </span>
              </div>
        ...
        <Link
          href="/projects"
          className="group relative flex max-w-max items-center gap-4 text-base font-semibold min-sm:text-lg min-md:text-xl"
        >
          ...
          <div className="h-8 w-8">
            <CgArrowTopRight className="rotate-45 text-accent transition-transform duration-300 group-hover:rotate-0 group-hover:scale-[1.1]" />
          </div>
        </Link>
      </div>
    </section>
